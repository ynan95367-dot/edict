...
STATE_ORG_MAP = {
    'Taizi': '太子',
    'Pending': '待办', 'Doing': '执行中',
    'Done': '完成', 'Blocked': '阻塞',
    'Review': '验证中', 'Cancelled': '已取消',
}
...
_AGENT_LABELS = {
    ...
    'gongbu': '工部', 'libu_hr': '吏部',
    'jira_bridge': 'JIRA交互', 'version_integrator': '版本集成',
...
# ── 越权检测（Agent 权限策略）──
AGENT_POLICY = {
    "taizi":    {"role": "coordination", "commands": {"create", "state", "flow", "progress", "todo", "memory", "task-memo", "done"}},
    "hubu":     {"role": "execution", "commands": {"progress", "todo", "done", "state", "flow", "block", "memory", "task-memo", "delegate-result"}},
    "libu":     {"role": "execution", "commands": {"progress", "todo", "done", "state", "flow", "block", "memory", "task-memo", "delegate-result"}},
    "bingbu":   {"role": "execution", "commands": {"progress", "todo", "done", "state", "flow", "block", "memory", "task-memo", "delegate-result"}},
    "xingbu":   {"role": "execution", "commands": {"progress", "todo", "done", "state", "flow", "block", "memory", "task-memo", "delegate-result"}},
    "gongbu":   {"role": "execution", "commands": {"progress", "todo", "done", "state", "flow", "block", "memory", "task-memo", "delegate-result"}},
    "libu_hr":  {"role": "execution", "commands": {"progress", "todo", "done", "state", "flow", "block", "memory", "task-memo", "delegate-result"}},
    "jira_bridge":       {"role": "service", "commands": {"progress", "done"}},
    "version_integrator": {"role": "service", "commands": {"progress", "done"}},
    "report_generator":   {"role": "service", "commands": {"progress", "done"}},
}
