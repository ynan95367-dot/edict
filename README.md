...
<p align="center">
  <img src="https://img.shields.io/badge/Runtime-OpenCode%20%2F%20OpenClaw-blue?style=flat-square" alt="Agent Runtime">
...
> 🐳 **暂时不接运行时？** 跑一行 `docker run -p 7891:7891 cft0808/edict` 即可体验完整看板 Demo（预置模拟数据）。
...
#### 前置条件
- OpenCode 或 [OpenClaw](https://openclaw.ai) 已安装
- Python 3.10+
- macOS / Linux
