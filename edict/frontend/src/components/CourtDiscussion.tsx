...
const OFFICIAL_COLORS: Record<string, string> = {
  taizi: '#d9ae5f', zhongshu: '#b692f6', menxia: '#59d0c2', shangshu: '#58d68d',
  libu: '#d9ae5f', hubu: '#f59e72', bingbu: '#ef6f64', xingbu: '#e06b6b',
  gongbu: '#75bdff', libu_hr: '#c08df4',
};
        ...
        <div className="bg-[var(--panel)] rounded-xl p-4 border border-[var(--line)]">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-2">
            {DEPTS.map((d) => {
              ...
              const color = OFFICIAL_COLORS[d.id] || '#59d0c2';
              return (
                <button
                  key={d.id}
          ...
          style={{
            background:
              selectedIds.size >= 2 && topic.trim()
                ? 'linear-gradient(135deg, #59d0c2, #d9ae5f)'
                : 'var(--panel2)',
        ...
        <div className="bg-[var(--panel)] rounded-xl p-3 border border-[var(--line)] relative overflow-hidden min-h-[320px]">
          ...
          <div className="relative" style={{ minHeight: 250 }}>
            ...
            {officials.map((o) => {
              ...
              const color = OFFICIAL_COLORS[o.id] || '#59d0c2';
...
function MessageBubble({
  ...
  const color = OFFICIAL_COLORS[msg.official_id || ''] || '#59d0c2';
